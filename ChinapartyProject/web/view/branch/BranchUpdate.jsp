	...
	<div class="x-body">
		<form class="layui-form">
			<div class="layui-form-item">
				<input type="hidden" name="cid" value="${mds.branch_id }">
			...
			<div class="layui-form-item">
				<label for="s_username" class="layui-form-label"> <span
					class="x-red">*</span>是否可用
				</label>
				<div class="layui-input-inline">
					<c:choose>
						<c:when test="${mds.branchFlag=='启用' }">
							<input type="radio" name="cflag" value="1" checked="checked"
								title="启用"></input>
							<!-- <div class="layui-form-radio layui-form-radio"><i class="layui-anim layui-icon"></i></div> -->
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input id="cdate" name="cdate" required lay-verify="required"
						autocomplete="off" class="layui-input"
						value="${mds.branchCDate }">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="cdate" class="layui-form-label"> <span></span>
				</label>
				<div class="layui-input-inline">
	...
	<script>
		...
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(update)', function(data) {
				...
				$.ajax({
					type : 'POST',
					url : '/ChinapartyProject/updateBranchServlet',
					data : data.field,
					success : function(data) {//从服务器穿回来的数据
						if (data == "Ok") {
							layer.alert("操作成功", {
								icon : 6
							}, function() {
