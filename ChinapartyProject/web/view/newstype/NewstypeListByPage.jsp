...
<body>
	<div class="x-body">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so">
				...
				<div class="layui-input-inline" id="search">
					...
					<input type="text" name="cname" id="cname" placeholder="请输入资源名称" autocomplete="off" class="layui-input">
		...
		<button class="layui-btn"
			onclick="x_admin_show('添加资源','<%=path%>/view/newstype/Newstype.jsp',700,400)">
     ...
     layui.use('laydate',function(){
      ...
      function member_stop(obj,id){
		...
		layui.use('table',function(){
			...
			table.render({
				elem:'#mytable'
				,url:'/ChinapartyProject/getAllNewstypeByPageServlet'
				,method:'post'
				,cols:[[
						{type:'checkbox'}
						,{title:'序号',type:'numbers'}
						// ,{title:'ID',hide:'newstype_id'}
						,{title:'资源名',field:'newstypeName',sort:true}
						,{title:'状态',field:'newstypeFlag',sort:true}
						,{title:'操作时间',field:'newsstypeCDate',sort:true}
			  ...
			  table.on('tool(mytable)', function(obj){
			    ...
			    if(obj.event === 'del'){//恒等
			      layer.confirm('真的删除行么', function(index){
			    	  $.ajax({
		          		  type:'POST'
		          		  ,url:'/ChinapartyProject/deleteNewstypeServlet'
		          		  ,data:{"cid":data.newstype_id}
			    	...
			    	x_admin_show('编辑','/ChinapartyProject/findNewstypeServlet?cid='+data.newstype_id,700,400);
			    }
			  }); 
              //查询
              var active={
