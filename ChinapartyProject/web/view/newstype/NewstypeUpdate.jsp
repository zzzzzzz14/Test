...
<div class="x-body">
       <form class="layui-form">
          ...
          <input type="hidden" name="cid" value="${mds.newstype_id }"/>
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${mds.newstypeName }">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>资源名不能同名
              </div>
          </div>
          <div class="layui-form-item">
              <label for="s_username" class="layui-form-label">
                  <span class="x-red">*</span>是否可用
              </label>
              <div class="layui-input-inline">
                  <c:choose>
                		<c:when test="${mds.newstypeFlag=='启用'}">
         ...
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${mds.newsstypeCDate }">
			</div>
         </div>
         <div class="layui-form-item">
              <label for="cdate" class="layui-form-label">
...
<script>
    ...
    layui.use(['form','layer'], function(){
      ...
      form.on('submit(update)', function(data){
        ...
        $.ajax({
        	type:'POST'
        	,url:'/ChinapartyProject/updateNewstypeServlet'
        	,data:data.field
