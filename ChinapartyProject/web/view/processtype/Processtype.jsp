...
<body>
	...
	<form action="${pageContext.request.contextPath }/addProcesstypeServlet" method="post"></form>
	<div class="x-body">
        <form class="layui-form">
          <div class="layui-form-item">
              ...
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>活动名称不能同名
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  <input type="radio" id="cflag" name="cflag" value="0" title="禁用" />
                  </div>
          </div>
     ...
     <script>
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            ...
            $.ajax({
            	type:'POST'
            	,url:'/ChinapartyProject/addProcesstypeServlet'
            	,data:data.field
