...
<body>
	<div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
        	<div class="layui-input-inline" id="search">
          		...
          		<input type="text" name="cname" id="cname"  placeholder="请输入角色名称" autocomplete="off" class="layui-input">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加角色','<%=path %>/view/roles/Roles.jsp',700,400)"><i class="layui-icon"></i>添加</button>
    ...
    layui.use('laydate',function(){
      ...
      layui.use('table',function(){
    	  ...
    	  table.render({
    		  elem:'#mytable'
    		  ,url:'/ChinapartyProject/getAllRolesByPageServlet'
    		  ,method:'post'
    		  ,cols:[[
	    			  {type:'checkbox'}
	    			  ,{title:'序号',type:'numbers'}
	    			  // ,{title:'ID',hide:'roles_id'}
	    			  ,{title:'名称',field:'rolesName',sort:true}
	    			  ,{title:'操作时间',field:'rolesCDate',sort:true}
    	  ...
    	  table.on('tool(mytable)', function(obj){
    	    ...
    	    if(obj.event === 'del'){
    	      layer.confirm('真的删除行么', function(index){
   	    	  $.ajax({
   	            	 type:'POST'
   	            	 ,url:'/ChinapartyProject/deleteRolesServlet'
   	            	 ,data:{"cid":data.roles_id}
    	    	...
    	    	x_admin_show('编辑','/ChinapartyProject/findRolesServlet?cid='+data.roles_id,700,400);
    	    }
    	  }); 
    	//查询
    	var active={
