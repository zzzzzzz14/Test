	...
	<div class="x-body">
		<form class="layui-form">
			<div class="layui-form-item">
				<input type="hidden" name="cid" value="${mds.roles_id }">
				<label for="classname" class="layui-form-label"> <span
					class="x-red">*</span>角色名称
				</label>
				<div class="layui-input-inline">
					<input type="text" id="cname" name="cname" required
						lay-verify="required" autocomplete="off" class="layui-input" value="${mds.rolesName }">
				</div>
				<div class="layui-form-mid layui-word-aux">
					<span class="x-red">*</span>角色名称不能同名
				</div>
			</div>
			<div class="layui-form-item">
				<label for="classcdate" class="layui-form-label"> <span
					class="x-red">*</span>操作时间
				</label>
				<div class="layui-input-inline">
					<input class="layui-input" id="cdate" name="cdate" required
						lay-verify="required" autocomplete="off" value="${mds.rolesName }">
				</div>
			</div>
			<div class="layui-form-item">
	...
	<script>
		...
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(update)', function(data) {
				...
				$.ajax({
					type : 'POST',
					url : '/ChinapartyProject/updateRolesServlet',
					data : data.field,
