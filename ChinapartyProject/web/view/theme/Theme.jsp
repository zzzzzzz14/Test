			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="radio" id="cflag" name="cflag" value="0" title="未测试"
						checked="checked" /> <input type="radio" name="cflag" value="1"
						title="开始测试" /><br/><input type="radio" name="cflag" value="2"
						title="已测试" />
				</div>
			</div>
	...
	<script>
		...
		layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            ...
            $.ajax({
             type:'POST'
             ,url:'/ChinapartyProject/addThemeServlet'
             ,data:data.field
