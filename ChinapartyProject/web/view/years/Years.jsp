	...
	<div class="x-body">
		<form class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="radio" id="yearsflag" name="yearsflag" value="1"
						title="启用" checked="checked" /> <input type="radio"
						id="yearsflag" name="yearsflag" value="0" title="禁用" />
				</div>
			</div>
			<div class="layui-form-item">
				<label for="years" class="layui-form-label"> <span></span>
				</label>
				<div class="layui-input-inline">
	...
	<script>
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(add)', function(data) {
				...
				$.ajax({
					type : 'POST',
					url : '/ChinapartyProject/addYearsServlet',
					data : data.field,
